            ...
            <div className=" bg-black">
                <div className="max-w-2xl mx-auto text-white py-10">
                    <div className="text-center">
                        <h3 className="text-3xl mb-3"> Download our EOC App </h3>
                        <p> Be an extra ordinary people with EOC, All day, Every day. </p>
                    ...
                    <div className="mt-10 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400">
                        <p className="order-2 md:order-1 mt-8 md:mt-0"> &copy; Murad-2023. </p>
